...
import 'package:amazon_flutter/features/update_profile/update_profile_ctrl/update_profile_ctrl.dart';
              ...
              Positioned(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: GetBuilder<UpdateProfileCtrl>(builder: (addressCtrl) {
                      return Row(
                        children: [
                          Icon(
                            Icons.location_on,
